// Mock data otimizado para telas do profissional (baseado no João Silva)
export const workerProfile = {
  ...
  price: "R$ 80/dia",
  avatar:
    "https://images.unsplash.com/photo-1659353589552-1556f5093206?w=400&h=400&fit=crop&crop=face",
  portfolio: [
    "https://images.unsplash.com/photo-1618832515490-e181c4794a45?w=600&h=400&fit=crop",
    "https://images.unsplash.com/photo-1515588562968-3d1a385e4e4f?w=600&h=400&fit=crop",
    "https://images.unsplash.com/photo-1625337903959-5087244ce860?w=600&h=400&fit=crop",
  ],
};
...
export const workerBookings = [
  {
    ...
    description:
      "Preciso construir um muro de 20 metros para dividir o quintal. Material já está disponível no local.",
    price: "R$ 1.600",
  },
  {
    id: 2,
    ...
    description:
      "Renovar parede da sala com novo acabamento. Trabalho de médio porte.",
    price: "R$ 1.200",
  },
  {
    id: 3,
    ...
    description:
      "Construir churrasqueira de alvenaria no quintal, projeto já definido.",
    price: "R$ 2.400",
  },
  {
    id: 4,
